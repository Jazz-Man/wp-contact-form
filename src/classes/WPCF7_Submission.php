...
class WPCF7_Submission
{
    ...
    private function setup_posted_data()
    {
        ...
        $posted_data = array_diff_key($posted_data, ['_wpnonce' => '']);
    ...
    private function submit()
    {
        ...
        $this->meta = array_merge($this->meta, [
            ...
            'unit_tag' => isset($_POST['_wpcf7_unit_tag']) ? $_POST['_wpcf7_unit_tag'] : '',
    ...
    private function before_send_mail()
    {
        ...
        do_action_ref_array('wpcf7_before_send_mail', [
            $this->contact_form,
            &$abort,
            $this,
        ]);
