...
class WPCF7_ContactForm
{
    ...
    public function get_properties()
    {
        ...
        return (array) apply_filters('wpcf7_contact_form_properties',
            $properties, $this);
    }
    ...
    public function form_html($args = '')
    {
        ...
        $html = sprintf('<div %s>',
            wpcf7_format_atts([
                ...
                'class' => 'wpcf7',
                'id' => $this->unit_tag(),
                ('text/html' == get_option('html_type')) ? 'lang' : 'xml:lang' => $lang_tag,
    ...
    public function filter_message($message, $status = '')
    {
        ...
        $message = wpcf7_mail_replace_tags($message, ['html' => true]);
